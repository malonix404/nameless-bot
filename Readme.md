...
<img src="lib/bot_image.jpg" alt="Nameless Bot" width="260">

</div>

Nameless Bot is a WhatsApp MD bot built on top of the **Baileys** library.  
...
- **Optimized for Stability** – RAM‑optimized media handling (streaming, temp cleanup), better session handling via `sessionID` in `settings.js`.  
...
<a href="https://github.com/malonix404/nameless-bot/fork" target="_blank">
...
> This creates your own copy of `Nameless-bot` under your GitHub account.
...
<a href="https://nameless-paircode-tbox.onrender.com/" target="_blank">
...
Copy that full string and paste it into `settings.js`:

```js
sessionID: 'NamelessBot!H4.....'
```
...
```bash
git clone https://github.com/malonix404/nameless-bot.git
cd nameless-bot
```
...
<a href="https://t.me/xpro_vpn" target="_blank">
...
<a href="https://whatsapp.com/channel/0029Vb8QhvR6xCSJ6dLVwL0Z" target="_blank">
...
- **Dev Malone** – Main developer & maintainer  
